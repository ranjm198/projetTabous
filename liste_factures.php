...
Espace Administrateur            </a>
    ...
    <a href="imprimer_facture.php?id=<?= $facture['id'] ?>" class="btn btn-primary btn-sm" title="Imprimer">
        <i class="fa fa-print"></i>
    </a>
  
    <a href="supprimer_facture.php?id=<?= $facture['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Supprimer cette facture ?')" title="Supprimer">
        <i class="fa fa-trash"></i>
                                ...
                                <?php endforeach; ?>
                            <?php else: ?>
                                <tr><td colspan="5" class="text-center text-muted">Aucune facture trouvée.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
